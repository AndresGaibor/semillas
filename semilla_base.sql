...
-- ============================================================
-- 12. MIGRACIÓN COMPLEMENTARIA: GAMIFICACIÓN Y PLATAFORMA
-- ============================================================
-- Aplicada via: 20260712000005_platform_completion.sql
-- Incluida aquí para crear base desde cero.
...
-- Backfill XP histórico desde eventos de progreso existentes.
...
-- 6) movimiento_xp es el libro mayor autoritativo de XP; no modificar manualmente.
-- 7) Las tablas de gamificación (configuracion_plataforma, movimiento_xp, racha_usuario,
--    notificacion_usuario) NO deben consultarse directamente desde el navegador.
-- ============================================================
