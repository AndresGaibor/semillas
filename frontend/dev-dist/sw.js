...
define(['./workbox-50595c2f'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.startsWith("/__offline_media/"), new workbox.CacheOnly({
    "cacheName": "semillas-offline-media-v1",
    plugins: []
  }), 'GET');
  workbox.registerRoute(({
    request
