    ...
    <Card sombra="sm" className="p-5 flex flex-col text-left">
      ...
      {!selectedResource ? (
        <div className="flex flex-col items-center justify-center py-16 text-center select-none">
          <i className="fa-regular fa-image text-slate-300 text-4xl mb-3.5" />
          <EmptyState
        ...
        <>
          <div className="w-full h-44 rounded-2xl overflow-hidden bg-slate-50 border border-slate-200 flex items-center justify-center shrink-0">
          ...
          <div className="flex flex-col mt-4">
            ...
            <p className="text-xs font-semibold text-slate-500 bg-slate-50 rounded-xl p-3 border border-slate-200 leading-relaxed text-left">
            ...
            <div className="flex flex-wrap gap-1.5 select-none">
              {selectedResource.etiquetas.length === 0 ? (
                ...
                <span
                  key={t}
                  className="px-2.5 py-1 rounded-full bg-slate-50 border border-slate-200 text-xs font-extrabold text-slate-600"
                >
                  {t}
                </span>
              ))}
            ...
            <div className="flex flex-col gap-2.5 mt-6 pt-5 border-t border-slate-200 select-none">
              <Boton
