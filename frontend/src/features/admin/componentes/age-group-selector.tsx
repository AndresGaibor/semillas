        ...
        {ageGroups.map((ag) => {
          ...
          return (
            <button
              ...
              className={`rounded-[1.5rem] border p-4 text-left transition-all ${isActive ? "border-green-600 bg-green-50 shadow-sm" : "border-slate-200 bg-white hover:border-green-600/30 hover:bg-slate-50"}`}
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className={`rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.18em] ${isActive ? "bg-green-600 text-white" : "bg-slate-100 text-slate-500"}`}>
