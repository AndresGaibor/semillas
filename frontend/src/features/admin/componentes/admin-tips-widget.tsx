    ...
    <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-sm flex flex-col text-left gap-4">
      ...
      <div className="flex gap-3">
        ...
        <div className="flex flex-col text-left">
          <span className="font-extrabold text-slate-700 text-xs sm:text-sm">Varía los tipos de actividades</span>
          <span className="text-xs text-slate-400 mt-0.5 leading-snug">Combina diferentes formatos para mantener el aprendizaje dinámico y entretenido.</span>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex flex-col text-left">
          <span className="font-extrabold text-slate-700 text-xs sm:text-sm">Alinea con la senda</span>
          <span className="text-xs text-slate-400 mt-0.5 leading-snug">Asegúrate de que cada actividad refuerce el tema y objetivo de la senda.</span>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="flex flex-col text-left">
          <span className="font-extrabold text-slate-700 text-xs sm:text-sm">Revisa antes de publicar</span>
          <span className="text-xs text-slate-400 mt-0.5 leading-snug">Una buena revisión garantiza claridad, precisión y una mejor experiencia para los niños.</span>
        </div>
      </div>
      ...
      <div className="mt-2 bg-[#eefcf4] rounded-2xl p-4 border border-[#e2f7ea] flex gap-3 text-left">
        ...
        <p className="text-xs font-bold text-[#123b2c] leading-snug mt-0.5">
