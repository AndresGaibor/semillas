...
import { Field } from "@/features/admin/componentes/Field";
import { TagInput } from "@/features/admin/componentes/TagInput";
import { ThemePreviewCard } from "@/features/admin/componentes/ThemePreviewCard";
import { ActivityFormPanel } from "@/features/admin/componentes/activity-form-panel";
import { ActivityEmptyState, ActivityHeader, ActivityLoadingState } from "@/features/admin/componentes/activity-header";
import { BackButton } from "@/features/admin/componentes/admin-back-button";
import { AdminListLayout } from "@/features/admin/componentes/admin-list-layout";
...
import { ClubVisibilitySelector, type ClubVisibilidades } from "@/features/admin/componentes/club-visibility-selector";
import { CoverImageUpload } from "@/features/admin/componentes/cover-image-upload";
...
import { PasoActividades } from "@/features/admin/componentes/paso-actividades";
import { PasoCrecer } from "@/features/admin/componentes/paso-crecer";
import { PasoEscritura } from "@/features/admin/componentes/paso-escritura";
import { PasoInformacionGeneral } from "@/features/admin/componentes/paso-informacion-general";
import { PasoMedia } from "@/features/admin/componentes/paso-media";
...
import { EmptyState, SectionCard } from "@/features/admin/componentes/section-card";
import { StepIndicator } from "@/features/admin/componentes/step-indicator";
...
import { ThemePreviewHeader } from "@/features/admin/componentes/theme-preview-header";
          ...
          <div className="border-t border-slate-200 pt-8">
            ...
            <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
              <div className="grid gap-5">
                ...
                <CrecerContentEditor activeStep={pasos.find((item) => item.codigo === paso)} selectedAgeGroup={grupos.find((item) => item.id === grupo) ?? null} title={titulo} body={cuerpo} shortInstruction={instruccion} onTitleChange={setTitulo} onBodyChange={setCuerpo} onShortInstructionChange={setInstruccion} onSave={() => undefined} isPending={false} isSuccess />
