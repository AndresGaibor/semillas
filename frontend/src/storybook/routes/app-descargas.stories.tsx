...
const temas: TemaDescargaUI[] = [
  { id: "1", titulo: "El Amor de Dios", descripcion: "Aprende sobre el amor fiel y cercano de Dios.", imagenUrl: "/storybook/fixtures/cover.svg", senda: "Senda del Padre", color: "#d68b13", minutos: 20, xp: 150, version: 1, descargado: true, actualizacionDisponible: false, tamanoBytes: 18_000_000, pasos: 6, actividades: 8, medios: 12, descargadoEn: "2026-07-10T12:00:00.000Z", progresoDescarga: null, errorDescarga: null },
  { id: "2", titulo: "Jesús enseña con parábolas", descripcion: "Historias sencillas para comprender verdades profundas.", imagenUrl: "/storybook/fixtures/cover.svg", senda: "Senda del Hijo", color: "#2676d2", minutos: 20, xp: 150, version: 2, descargado: false, actualizacionDisponible: false, tamanoBytes: null, pasos: null, actividades: null, medios: null, descargadoEn: null, progresoDescarga: null, errorDescarga: null },
];
...
const meta = { title: "05 · Pantallas/App/Descargas", component: DescargasPageStory, parameters: { layout: "fullscreen" } } satisfies Meta<typeof DescargasPageStory>;
export default meta;
