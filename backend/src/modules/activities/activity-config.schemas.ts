...
export const actividadConfigSchema = z.discriminatedUnion("tipo", [
...
export function validarConfiguracionActividad(codigo: string, configuracion: unknown) {
  return actividadConfigSchema.safeParse({
    ...(typeof configuracion === "object" && configuracion !== null ? configuracion : {}),
    tipo: codigo,
  });
}
